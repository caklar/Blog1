...
public class article_info_Dao extends BaseDao {
    ...
    public List<Map<String, Object>> get_id_article(String id){
        List<Map<String ,Object>> list=null;
        String sql="SELECT * from article_info where a_cid=? ORDER  BY a_date DESC";
    ...
    public List<Map<String ,Object>> get_exhibit_info(int id){
        List<Map<String,Object>> list=null;
        String sql="SELECT a_title,a_context,a_date,a_ldate from article_info where a_id=? ORDER  BY a_date DESC";
        list=super.executeQuery(sql,id);
        return list;
    }
    //显示文章分类
