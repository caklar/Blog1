...
<header>
    ...
    <div class='nav_bar'>
        ...
        <div class="menu_panel">
            ...
            <div class="bar_menu_ch"><a href="JavaScript:void(0);" id="archive">归档</a></div>
            <div class="bar_menu_ch"><a href="JavaScript:void(0);" id="classify">标签</a></div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/wsy.js"></script>
